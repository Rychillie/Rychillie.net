enum Theme {
  enum Shell {
    ...
    static let container = "relative mx-auto flex w-full max-w-[393px] flex-col items-start gap-6 px-6 py-36 md:max-w-[640px] md:px-0"
    static let bottomFade = "pointer-events-none absolute bottom-0 left-1/2 h-36 w-full max-w-[393px] -translate-x-1/2 bg-gradient-to-b from-white/0 to-white dark:from-neutral-950/0 dark:to-neutral-950 md:max-w-[640px]"
  ...
  enum Home {
    ...
    static let card = "flex min-h-[88px] w-full items-center justify-between gap-3 rounded border border-neutral-200 bg-neutral-50 py-3 pl-3 pr-4 no-underline transition-colors hover:border-neutral-300 hover:bg-white dark:rounded-lg dark:border-neutral-800 dark:bg-neutral-950 dark:hover:border-neutral-700 dark:hover:bg-neutral-900/50"
    static let cardStatic = "flex min-h-[88px] w-full items-center justify-between gap-3 rounded border border-neutral-200 bg-neutral-50 py-3 pl-3 pr-4 dark:rounded-lg dark:border-neutral-800 dark:bg-neutral-950"
    static let profileGroup = "flex min-w-0 items-center gap-3"
    static let profile = "relative size-16 shrink-0"
    static let profileImage = "size-16 rounded-full object-cover"
    static let profileBadge = "absolute bottom-0 right-0 flex size-5 items-center justify-center rounded-full border border-neutral-200 bg-white dark:border-neutral-800 dark:bg-neutral-950"
    static let cardDetails = "flex min-w-0 flex-col justify-center gap-1"
    static let cardTitle = "m-0 break-words text-base font-bold leading-6 text-neutral-950 dark:text-neutral-50"
    static let cardMeta = "m-0 text-sm font-normal leading-5 text-neutral-800 dark:text-neutral-200"
    static let arrow = "size-6 shrink-0"
    static let list = "flex w-full flex-col gap-2 md:gap-2.5"
    static let listCard = "flex min-h-[88px] w-full items-center justify-between gap-3 rounded border border-neutral-200 bg-neutral-50 py-3 pl-3 pr-4 dark:rounded-lg dark:border-neutral-800 dark:bg-neutral-950"
    static let listDetails = "flex min-w-0 flex-1 flex-col justify-center gap-1"
    ...
    static let brandChip = "flex h-12 items-center gap-3 rounded border border-neutral-200 bg-neutral-50 py-3 pl-3 pr-4 dark:rounded-lg dark:border-neutral-800 dark:bg-neutral-950"
    ...
    static let socialAction = "flex items-center gap-2 text-base font-normal leading-6 text-neutral-800 dark:text-neutral-200"
  ...
  enum Notes {
    ...
    static let list = "flex w-full flex-col gap-2 md:gap-2.5"
    static let card = "flex min-h-[88px] w-full items-center justify-between gap-3 rounded border border-neutral-200 bg-neutral-50 py-3 pl-3 pr-4 no-underline transition-colors hover:border-neutral-300 hover:bg-white dark:rounded-lg dark:border-neutral-800 dark:bg-neutral-950 dark:hover:border-neutral-700 dark:hover:bg-neutral-900/50"
    static let cardDetails = "flex min-w-0 flex-1 flex-col justify-center gap-1"
    static let cardTitle = "m-0 break-words text-base font-bold leading-6 text-neutral-950 dark:text-neutral-50"
    static let cardSummary = "m-0 break-words text-sm font-normal leading-5 text-neutral-800 dark:text-neutral-200"
    static let cardMeta = "m-0 text-sm font-normal leading-5 text-neutral-800 dark:text-neutral-200"
    static let metaRow = "flex flex-wrap items-center gap-1"
    static let metaDot = "size-0.5 rounded-full bg-neutral-800 dark:bg-neutral-200"
    static let arrow = "size-6 shrink-0"
  ...
  enum Markdown {
    static let content = [
      "w-full break-words text-base leading-6 text-neutral-800 dark:text-neutral-200",
